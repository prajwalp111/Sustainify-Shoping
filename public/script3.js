...
<li class="row" > 
<div class="col"><span>${selectedFood}</span> kcal</div>
        <div class="col"><span>Calories:</strong>${calories}</span> kcal</div>
        <div class="col"><span>Protein:</strong> ${protein}</span> g</div>
        <div class="col"><span>Fats:</strong> ${fats}</span> g</div>
        <div class="col"><span> Essential Nutrients:<span >${nutrients}</span></div>
        <div class="col"><button class="btn btn-danger btn-sm" data-product="${selectedFood}" onclick="removeProduct(this,'${selectedFood}')">Remove</button></div>
    </div>
  `;
